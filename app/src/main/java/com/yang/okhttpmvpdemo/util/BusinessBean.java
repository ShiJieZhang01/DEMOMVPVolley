...
public class BusinessBean implements Serializable{
	...
	public String toString() {
		return "BusinessBean [status=" + status + ", total_count=" + total_count + ", businesses=" + businesses + "]";
	}
	...
	public static class Business implements Serializable{
		...
		public String toString() {
			return "Business [business_id=" + business_id + ", name=" + name + ", branch_name=" + branch_name
					...
					+ ", avg_rating=" + avg_rating + ", rating_img_url=" + rating_img_url + ", rating_s_img_url="
					+ rating_s_img_url + ", product_grade=" + product_grade + ", decoration_grade=" + decoration_grade
					+ ", service_grade=" + service_grade + ", product_score=" + product_score + ", decoration_score="
					+ decoration_score + ", service_score=" + service_score + ", avg_price=" + avg_price
					+ ", review_count=" + review_count + ", review_list_url=" + review_list_url + ", distance="
					+ distance + ", business_url=" + business_url + ", photo_url=" + photo_url + ", s_photo_url="
					+ s_photo_url + ", photo_count=" + photo_count + ", photo_list_url=" + photo_list_url
					+ ", has_coupon=" + has_coupon + ", coupon_id=" + coupon_id + ", coupon_description="
					+ coupon_description + ", coupon_url=" + coupon_url + ", has_deal=" + has_deal + ", deal_count="
					+ deal_count + ", deals=" + deals + ", has_online_reservation=" + has_online_reservation
